...
export default function ProfilePage({
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const response = await fetch(`/api/farm/${params.farmCode}/profile`);
        if (response.ok) {
          ...
          <div className="flex items-center space-x-8">
            <div className="relative group">
              <div className="w-32 h-32 rounded-2xl overflow-hidden shadow-xl">
                {previewImage && previewImage !== '/default-avatar.png' ? (
                  <img
                    src={previewImage}
                    alt="Profile"
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold text-5xl">
            ...
            <div className="flex-1">
              ...
              <div className="flex space-x-3">
                <label
                  htmlFor="profile-pic"
                  className="bg-green-600 text-white px-6 py-2 rounded-xl hover:bg-green-700 transition-colors font-semibold cursor-pointer inline-block"
                >
                  Upload Photo
                </label>
                <button
                  ...
                  className="bg-gray-200 text-gray-700 px-6 py-2 rounded-xl hover:bg-gray-300 transition-colors font-semibold"
                >
                  Remove
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  value={formData.role?.name || 'No role assigned'}
                  disabled
          ...
          <div className="mt-6">
            ...
            <div className="relative">
              <textarea
                ...
                placeholder="Tell us about yourself, your experience, and your role in the farm..."
              />
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-4">
              ...
              <button
                type="submit"
                disabled={saving}
                className="bg-green-600 text-white px-8 py-3 rounded-xl hover:bg-green-700 transition-colors font-semibold shadow-lg hover:shadow-xl flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {saving ? (
                  <>
